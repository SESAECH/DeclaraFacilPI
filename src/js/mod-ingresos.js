...
window.initIngresos = function initIngresos(data){
    ...
    /* $("#btnGuardarIngresos").unbind("click");
    $("#btnGuardarIngresos").on('click',function(event) {
        console.log("guardar ingresos...");
        window["guardarForm" + seccionName](seccion.no, seccionName, seccion.apartado);        
    }); */

    $(form + ".btnGuardar").on('click',function(event) {
        window["guardarForm" + seccionName](seccion.no, seccionName, seccion.apartado, "EN_PROCESO");        
    });
    $(form + ".btnTerminar").on('click',function(event) {
        event.preventDefault();
        window["guardarForm" + seccionName](seccion.no, seccionName, seccion.apartado, "TERMINADO");
    });    
...
window.guardarFormIngresos = function guardarFormIngresos(seccionNo, seccionName, seccionApartado, seccionstatus){       
    if ($("#formIngresos input[name='remuneracionMensualCargoPublicoCantidad']").val() == 0){ mensajeSwal('Error','El ingreso de la persona que declara debe ser mayor a 0','error');}
        ...
        switch(jsonResult.captura.tipo_declaracion){
            case "INICIAL":
                nodo.remuneracionMensualCargoPublico.valor =    parseInt($("#formIngresos input[name='remuneracionMensualCargoPublicoCantidad']").val());
                nodo.remuneracionMensualCargoPublico.moneda =   $("#formIngresos select[name='remuneracionMensualCargoPublicoMoneda'] option:selected").val();
                
                nodo.otrosIngresosMensualesTotal.valor =        parseInt($("#formIngresos input[name='otrosIngresosMensualesTotalCantidad']").val());
                nodo.otrosIngresosMensualesTotal.moneda =       $("#formIngresos select[name='otrosIngresosMensualesTotalMoneda'] option:selected").val();

                nodo.ingresoMensualNetoDeclarante.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoDeclaranteCantidad']").val());
                nodo.ingresoMensualNetoDeclarante.moneda =   $("#formIngresos select[name='ingresoMensualNetoDeclaranteMoneda'] option:selected").val();

                nodo.ingresoMensualNetoParejaDependiente.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoParejaDependienteCantidad']").val());
                nodo.ingresoMensualNetoParejaDependiente.moneda =   $("#formIngresos select[name='ingresoMensualNetoParejaDependienteMoneda'] option:selected").val();

                nodo.totalIngresosMensualesNetos.valor =    parseInt($("#formIngresos input[name='totalIngresosMensualesNetosCantidad']").val());
                nodo.totalIngresosMensualesNetos.moneda =   $("#formIngresos select[name='totalIngresosMensualesNetosMoneda'] option:selected").val();
                break;
            case "MODIFICACION":
                nodo.remuneracionAnualCargoPublico.valor =    parseInt($("#formIngresos input[name='remuneracionMensualCargoPublicoCantidad']").val());
                nodo.remuneracionAnualCargoPublico.moneda =   $("#formIngresos select[name='remuneracionMensualCargoPublicoMoneda'] option:selected").val();
                
                nodo.otrosIngresosAnualesTotal.valor =        parseInt($("#formIngresos input[name='otrosIngresosMensualesTotalCantidad']").val());
                nodo.otrosIngresosAnualesTotal.moneda =       $("#formIngresos select[name='otrosIngresosMensualesTotalMoneda'] option:selected").val();

                nodo.ingresoAnualNetoDeclarante.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoDeclaranteCantidad']").val());
                nodo.ingresoAnualNetoDeclarante.moneda =   $("#formIngresos select[name='ingresoMensualNetoDeclaranteMoneda'] option:selected").val();

                nodo.ingresoAnualNetoParejaDependiente.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoParejaDependienteCantidad']").val());
                nodo.ingresoAnualNetoParejaDependiente.moneda =   $("#formIngresos select[name='ingresoMensualNetoParejaDependienteMoneda'] option:selected").val();

                nodo.totalIngresosAnualesNetos.valor =    parseInt($("#formIngresos input[name='totalIngresosMensualesNetosCantidad']").val());
            ...
            case "CONCLUSION":
                ...
                nodo.otrosIngresosConclusionTotal.moneda =       $("#formIngresos select[name='otrosIngresosMensualesTotalMoneda'] option:selected").val();

                nodo.ingresoConclusionNetoDeclarante.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoDeclaranteCantidad']").val());
                nodo.ingresoConclusionNetoDeclarante.moneda =   $("#formIngresos select[name='ingresoMensualNetoDeclaranteMoneda'] option:selected").val();

                nodo.ingresoConclusionNetoParejaDependiente.valor =    parseInt($("#formIngresos input[name='ingresoMensualNetoParejaDependienteCantidad']").val());
                nodo.ingresoConclusionNetoParejaDependiente.moneda =   $("#formIngresos select[name='ingresoMensualNetoParejaDependienteMoneda'] option:selected").val();

                nodo.totalIngresosConclusionNetos.valor =    parseInt($("#formIngresos input[name='totalIngresosMensualesNetosCantidad']").val());
                nodo.totalIngresosConclusionNetos.moneda =   $("#formIngresos select[name='totalIngresosMensualesNetosMoneda'] option:selected").val();
                break;
        }            
        ...
        actualizarStatusSeccion(seccionApartado, seccionNo, seccionName, seccionstatus);
        if (seccionstatus =="TERMINADO"){
            $("#formIngresos .btnEditar").addClass("hide");
            $("#formIngresos .btnEliminar").addClass("hide");
            $("#formIngresos .btnAgregar").addClass("hide");
        }
    }
}
